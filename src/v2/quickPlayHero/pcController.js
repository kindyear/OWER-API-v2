...
async function getPCQuickPlayHeroInfo(req, res) {
    try {
        let {playerTag, heroID, refreshCache} = req.query;
        const heroName = heroesData.find(hero => hero.heroID.toString() === heroID).heroName;
        console.log(`${getCurrentTime()} Received pc quickPlay hero info request with playerTag: \u001b[33m${playerTag}\u001b[0m, heroID: \u001b[33m${heroID}\u001b[0m, heroName: \u001b[33m${heroName}\u001b[0m.`);
        ...
        // 构建动态的选择器
        const heroSelector = `.mouseKeyboard-view.Profile-view blz-section.stats.quickPlay-view span.stats-container.option-${selectedHero.heroSourceID}`;
        ...
        console.log(`${getCurrentTime()} \u001b[33m${playerTag}\u001b[0m‘s pc quickPlay hero data for heroID \u001b[33m${heroID}\u001b[0m has been scraped successfully.`);
...
module.exports = {getPCQuickPlayHeroInfo};
