...
async function getPCCompetitivePlayHeroInfo(req, res) {
    try {
        ...
        // 获取页面元素中的所有英雄信息
        const heroElements = $('body > main.main-content > div.mouseKeyboard-view.Profile-view > blz-section.stats.competitive-view > div.Profile-heroSummary--header > select[data-dropdown-id="hero-dropdown"] option')
            .map((index, element) => ({
