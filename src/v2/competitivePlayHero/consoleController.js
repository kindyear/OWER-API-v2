/*
    competitivePlayHero/consoleController.js
    处理玩家主机平台竞技模式英雄信息
*/
...
async function getConsoleCompetitivePlayHeroInfo(req, res) {
    try {
        let {playerTag, heroID, refreshCache} = req.query;
        const heroName = heroesData.find(hero => hero.heroID.toString() === heroID).heroName;
        console.log(`${getCurrentTime()} Received console competitive hero info request with playerTag: \u001b[33m${playerTag}\u001b[0m, heroID: \u001b[33m${heroID}\u001b[0m, heroName: \u001b[33m${heroName}\u001b[0m.`);
        ...
        // 获取页面元素中的所有英雄信息
        const heroElements = $('body > main.main-content > div.controller-view.Profile-view > blz-section.stats.competitive-view > div.Profile-heroSummary--header > select[data-dropdown-id="hero-dropdown"] option')
            .map((index, element) => ({
        ...
        // 构建动态的选择器
        const heroSelector = `.controller-view.Profile-view blz-section.stats.competitive-view span.stats-container.option-${selectedHero.heroSourceID}`;
        ...
        console.log(`${getCurrentTime()} \u001b[33m${playerTag}\u001b[0m‘s console competitive hero data for heroID \u001b[33m${heroID}\u001b[0m has been scraped successfully.`);
...
module.exports = {getConsoleCompetitivePlayHeroInfo};